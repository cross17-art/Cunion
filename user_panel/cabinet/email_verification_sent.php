                                    ...
                                    <form>
                                        ...
                                        <div class="alert alert-success alert-dismissible" role="alert">
                                            <div class="alert-message">
                                                <strong>Verification email sent!</strong> We have sent the verification link to you email:
                                                <?= $user_email ?>. Please check your email box and follow the link to finish the verification.
                                            </div>
                                        </div>

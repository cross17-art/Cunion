...
function search_image(ticker){
    ...
    document.querySelectorAll("[coin-name]").forEach((elem) => {
        let coinName = elem.getAttribute("coin-name");
        let link =  link_icon[search_image(coinName)];
        if(link !== undefined){
            elem.querySelector("img").setAttribute("src", link_icon[search_image(coinName)].currentSRC);
        } else {
            console.log({

...
function Buy() {
    ...
    fetch('https://cunion.io/client/cabinet/binance_api/terminal_api/buy_market.php', {
        method: 'POST',
        headers: {
...
function Sell(){
    ...
    fetch('https://cunion.io/client/cabinet/binance_api/terminal_api/sell_market.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function ShowAllOrders(){
    ...
    fetch('https://cunion.io/client/cabinet/binance_api/terminal_api/get_all_orders_by_symbol.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },

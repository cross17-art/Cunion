...
<!--    </div>-->
    ...
    <p scale-info lng="eng" class="mb-0">
        You can only be connected to one trader. Please disconnect the trader first
    </p>

<!--    <p scale-info style="display: none" lng="rus" class="mb-0">-->
<!--        Вы можете быть подключенны только к одному трейдеру в один момент времени. Пожалуйста отключитесть от текущего трейдера.-->
<!--    </p>-->

...
if(isset($_SESSION['user_email'])){
    ...
    $result = $conn->query("SELECT id, email, nickname FROM `users`"); //TODO get email->nicknames pairs

    $nicknames = $result->fetch_all(MYSQLI_ASSOC);
    echo json_encode(array("status"=>"success", "nicknames"=>$nicknames));
